...
Shader "NatureManufacture Shaders/VS Standard Specular Snow"
{
	Properties
	{
...
#define _SnowAmbientOcclusionPower_arr NatureManufactureShadersStandardSpecularSnow
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float3 lerpResult115 = lerp( normalizeResult201 , ( tanTriplanarNormal166 * appendResult169 ) , ( saturate( ( ase_worldNormal.y * clampResult224 ) ) * temp_output_106_0 ));
			...
			float4 lerpResult10 = lerp( lerpResult192 , ( triplanar162 * _SnowAlbedoColor_Instance ) , temp_output_220_0);
			...
			float4 lerpResult17 = lerp( ( tex2DNode29 * _SpecularPower_Instance ) , fixed4( ( appendResult151 * _SnowSpecularPower_Instance ) , 0.0 ) , temp_output_220_0);
			...
			float lerpResult28 = lerp( ( tex2DNode29.a * _SmoothnessPower_Instance ) , ( triplanar165.w * _SnowSmoothnessPower_Instance ) , temp_output_220_0);
